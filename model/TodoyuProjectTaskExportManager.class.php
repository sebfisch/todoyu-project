...
class TodoyuProjectTaskExportManager {
	...
	protected static function parseDataForExport(TodoyuProjectTask $task) {
		$exportData = array(
			...
			Todoyu::Label('project.task.attr.person_assigned')		=> $task->getAssignedPerson()->getFullName(),
			Todoyu::Label('project.task.attr.person_owner')			=> $task->getOwnerPerson()->getFullName(),
