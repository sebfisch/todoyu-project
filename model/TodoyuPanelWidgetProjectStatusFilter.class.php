...
class TodoyuPanelWidgetProjectStatusFilter extends TodoyuPanelWidgetStatusFilter implements TodoyuPanelWidgetIf {
	...
	public function __construct(array $config, array $params = array(), $idArea = 0) {
		...
		TodoyuPage::addJsOnloadedFunction('Todoyu.Ext.project.PanelWidget.ProjectStatusFilter.init.bind(Todoyu.Ext.project.PanelWidget.ProjectStatusFilter, ' . $filterJSON . ')', 100);
	}
	...
	protected function getStatusesInfos() {
		return TodoyuProjectStatusManager::getProjectStatusInfos();
	}
